...
% ----- EXPERIENCE -----
\section{Experience}
\cventry{Mar 2024 -- Present}{GNC Researcher}{Institute of Advanced Studies (IEAv)}{São José dos Campos, Brazil}{}{
\begin{itemize}
    \item Designed and developed a high-fidelity 6DOF simulation environment in C++ for rockets and hypersonic vehicles, focusing on aerodynamic model analysis and flight envelope validation.
...
\begin{itemize}
    ...
    \item Built a telemetry data dashboard using the library, enabling rapid issue debugging and system monitoring.
